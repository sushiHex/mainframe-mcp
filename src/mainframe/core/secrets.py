...
This is a best-effort denylist, not a guarantee — raw captures must also stay outside
public Git history. Keep this module free of third-party imports so capture
hooks can reuse it without loading the daemon or models.
"""
